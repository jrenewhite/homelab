...
- microplanes por subsistema en [colibri-microplans](./docs/colibri/colibri-microplans)
- flujo de versionado y reutilizacion en [08-repository-and-git-workflow.md](./docs/colibri/colibri-microplans/08-repository-and-git-workflow.md)
- estrategia de identidad en [09-identity-and-sso.md](./docs/colibri/colibri-microplans/09-identity-and-sso.md)
- base de `Ansible` en [ansible/README.md](./docs/colibri/ansible/README.md)
